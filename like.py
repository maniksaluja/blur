        ...
        if updates.get("ok"):
            for update in updates["result"]:
                if "channel_post" in update:
                    ...
                    # Verify message ID exists (assuming no direct getChatMessage method exists, this is skipped)
                    logging.info(f"Message ID {message_id} assumed valid. Sending reactions.")
